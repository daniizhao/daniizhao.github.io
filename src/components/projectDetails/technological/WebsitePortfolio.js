    ...
    <div className="project-detail-wrapper">
      <div className="project-detail">
        ...
        <div className="project-detail-column">
          ...
          <div>
            <img src="/assets/img/portfolio/colors.png" alt="website_color_palette" />
          </div>
        </div>
        <div className="project-detail-column">
          <div>
          ...
          <div className="project-detail-row">
            <div>
              <img src="/assets/img/portfolio/first-idea.png" alt="first_idea" />
            </div>
            <div>
              <img src="/assets/img/portfolio/second-idea.png" alt="second_idea" />
            </div>
          </div>
        </div>
        <div className="project-detail-column">
          ...
          <div className="project-detail-row">
            <div>
              <img src="/assets/img/portfolio/structure.png" alt="final_structure" />
            </div>
            <div>
              <img src="/assets/img/portfolio/FinalWebsite.png" alt="final_result" />
            </div>
          </div>
        </div>
      </div>
